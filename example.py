...
screen1.set_type(ScreenTypes.OPTIONS) # Set the type of the screen. This does return the screen object for chaining. This currently doesn't do anything, but it is here for future use.
